        ...
        <div className="flex flex-col flex-wrap gap-4 w-full md:w-3/4 bg-white">
          ...
          {saveLater.length > 0 && (
            <div className="flex mb-4 flex-col flex-wrap gap-4 w-full bg-white">
              <div className="p-3 font-semibold w-full text-lg border-b-2">
            ...
            >
              ...
              >
                ...
                <div className="flex gap-4">
                  <div
                    className="text-center py-2  w-1/2 border-2 border-gray-400  cursor-pointer"
                    onClick={() => setIsRemove(false)}
                  >
                    Cancel
                  </div>
                  <div
                    className="text-center py-2 w-1/2 bg-blue-400 text-white cursor-pointer"
                    onClick={() => {
                      setIsRemove(false);
                      removeHandler();
                    }}
